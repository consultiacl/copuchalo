...
if( $globals['mobile'] ) {
	echo '<div style="width:350px;padding: 5px 5px;text-align:left">';
} else {
	echo '<div style="width:750px;padding: 5px 5px;text-align:left">';
}
...
if ($votes) {
	...
	foreach ( $votes as $vote ) {
		...
		echo '<a href="'.get_user_uri($vote->user_login).'" title="'.$vote->user_login.': '.$vote_detail.'" target="_blank">';
