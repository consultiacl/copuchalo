...
<h1>Información legal para mediatize.info y condiciones de uso</h1>
<br/>
<em>IMPORTANTE: El acceso y navegación por mediatize.info y/o el uso de los servicios ofrecidos en este lugar implica que el usuario acepta la política de privacidad, el aviso legal y las condiciones de uso de este servicio. En caso de no aceptarlos, no debe usar mediatize.info</em><br />
<em>AVISO: Esta página solo aplica al lugar que se encuentra bajo el dominio mediatize.info</em><br />
<em>NOTICE: This page only applies to the site under the mediatize.info domain.</em>
<br /><br /><br />
...
El establecimiento de un hiperenlace, enlace, intercambio, no implica en ningún caso la existencia de relaciones entre <em>los gestores de mediatize.info</em> y el propietario del lugar web con la que se establezca, ni la aceptación y aprobación de sus contenidos o servicios.<br />
<em>Los gestores de mediatize.info</em> excluyen toda responsabilidad en los sitios enlazados desde esta web y no pueden controlar y no controlan que entre ellos aparezcan sitios de Internet cuyos contenidos puedan resultar ilícitos, ilegales, contrarios a la moral o a las buenas costumbres o inapropiados. El usuario, por tanto, debe extremar la prudencia en la valoración y utilización de la información, contenidos y servicios existentes en los sitios enlazados.<br />
<em>Los gestores de mediatize.info</em> excluyen toda responsabilidad por las noticias e informaciones publicadas por los usuarios, terceros y de las mismas serán responsables los usuarios o terceros de quienes procedan.<br />
<em>Los gestores de mediatize.info</em> hacen el <em>mejor esfuerzo</em> para garantizar la confidencialidad de los mensajes privados, sin embargo éstos no se guardan cifrados en la base de datos. Los gestores del sitio no se hace responsables en caso de divulgación de los mismos debido a actos de terceros sin relación con la empresa.<br /><br />

<h2 id="tos">Condiciones de uso</h2>
<ol>
<li>El título, entradilla, geolocalización y etiquetas de los envíos, así como también la categoría en el que se inserta, debe reflejar y no distorsionar el contenido del enlace. Mediatize no es un sitio de <em>microblogging</em>, o para generar noticias u opinión en el espacio reservado para la descripción del envío.</li>
...
<li>El usuario se abstendrá de intentar promocionar el voto desde sitios de terceros mediante el uso de técnicas informáticas distintas a las ofrecidas por Mediatize a través de los RSS y funcionalidades del API. </li>
