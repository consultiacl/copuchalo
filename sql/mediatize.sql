...
--
-- Host: 10.1.1.6    Database: mediatize
-- ------------------------------------------------------
...
CREATE TABLE `blogs` (
  ...
  `blog_type` enum('normal','blog','noiframe','redirector','aggregator','disabled') CHARACTER SET utf8 NOT NULL DEFAULT 'normal',
...
CREATE TABLE `links` (
  ...
  `link_uri` char(200) CHARACTER SET utf8 DEFAULT NULL,
  `link_url` varchar(512) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `rss` (
  ...
  `summary` text,
  `media_url` char(250) DEFAULT NULL,
  UNIQUE KEY `url` (`url`),
  KEY `date` (`date`),
...
-- Dump completed on 2018-04-16  2:43:27
